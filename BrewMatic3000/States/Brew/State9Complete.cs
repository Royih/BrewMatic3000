...
{
    public class State9Complete : State
    {

        public State9Complete(BrewData brewData, string[] initialMessage = null, int initialScreen = 0)
        ...
        public override Screen GetScreen(int screenNumber)
        {
            switch (screenNumber)
            {
                case (int)Screens.Default:
                    {
                        var strLine1 = "= Brew: Complete =";
                        var strLine2 = "";
                        var strLine3 = "My wrk is done:)";
                        var strLine4 = "";
        ...
        {
            BrewData.BrewComplete = DateTime.Now;
            BrewData.LogBrewEventToFile("Brew complete.");
        }
