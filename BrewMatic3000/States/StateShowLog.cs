                ...
                case (int)Screens.Screen2:
                    {
                        ...
                        var strLine3 = "Sparge:     " + BrewData.BrewBoilStart.Subtract(BrewData.BrewSpargeStart).Display();
                        var strLine4 = "Boil:      " + BrewData.BrewCooldownStart.Subtract(BrewData.BrewBoilStart).Display();
                        return new Screen(screenNumber, new[] { strLine1, strLine2, strLine3, strLine4 });
                    }
                case (int)Screens.Screen3:
                    {
                        var strLine1 = "=Brew Log p3 =";
                        var strLine2 = "Cooldown:   " + BrewData.BrewComplete.Subtract(BrewData.BrewCooldownStart).Display();
                        var strLine3 = "Total:      " + BrewData.BrewComplete.Subtract(BrewData.BrewWarmupStart).Display();
                        var strLine4 = "";
                        return new Screen(screenNumber, new[] { strLine1, strLine2, strLine3, strLine4 });
                    }
