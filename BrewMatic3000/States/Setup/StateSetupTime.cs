...
{
    public class StateSetupTime : State
    {
        ...
        public StateSetupTime(BrewData brewData, string[] initialMessage = null, int initialScreen = 0)
        ...
        public override void KeyPressNextLong()
        {
            ...
            {
                Microsoft.SPOT.Hardware.Utility.SetLocalTime(_tmpDateTime);
                RiseStateChangedEvent(new StateSetup(BrewData, null, (int)StateSetup.Screens.Time));
            }
        }

        protected override void StartExtra()
        {
            _tmpDateTime = new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, DateTime.Now.Hour, DateTime.Now.Minute, 0);
        }
