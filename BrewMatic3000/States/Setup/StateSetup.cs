    ...
    public class StateSetup : State
    {
        ...
        public override Screen GetScreen(int screenNumber)
        {
            switch (screenNumber)
            {
                ...
                case (int)Screens.BoilTime:
                    {
                        var line1 = "=  Setup  =";
                        var line2 = "";
                        var line3 = "Boil time";
                        var line4 = "Current: " + BrewData.Config.BoilTime + "min";
                        return new Screen(screenNumber, new[] { line1, line2, line3, line4 }, line3);
                    }
        ...
        public override void KeyPressNextLong()
        {
            ...
            if (GetCurrentScreenNumber == (int)Screens.BoilTime)
            {
                RiseStateChangedEvent(new StateSetupBoilTime(BrewData));
            }
