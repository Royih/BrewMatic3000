...
using BrewMatic3000.States.SlaveMode;
...
namespace BrewMatic3000
{
    public class SlaveMode
    {
        ...
        public SlaveMode(NavigateButtons navButtons, LiquidCrystal_I2C lcd, PT100Reader tempReader1, PT100Reader tempReader2, OutputPort portHeater1, OutputPort portHeater2)
        {
            Lcd = lcd;
        ...
        public void Run()
        {
            ...
            ApplyState(new StateSlaveMode(brewData));
