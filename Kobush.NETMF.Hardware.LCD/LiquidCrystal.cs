...
namespace Kobush.NETMF.Hardware.LCD
{
    ...
    {
        private readonly ILiquidCrystalTransferProvider _provider;
        ...
        public LiquidCrystal(ILiquidCrystalTransferProvider provider)
        {
        ...
        protected ILiquidCrystalTransferProvider Provider
        {
...
/*       
        ...
        public void SetCursorPosition(int column, int row)
        {
            ...
            int address = column + row_offsets[row];
