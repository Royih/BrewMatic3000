...
{
    public class Shifter74Hc595LiquidCrystalTransferProvider : BaseShifterLiquidCrystalTransferProvicer, IDisposable
    {
        private readonly BitOrder _bitOrder;
        private readonly SPI _spi;
        private bool _disposed;

        public Shifter74Hc595LiquidCrystalTransferProvider(SPI.SPI_module spiBus, Cpu.Pin latchPin, BitOrder bitOrder)
        {
            _bitOrder = bitOrder;
        ...
        public Shifter74Hc595LiquidCrystalTransferProvider(SPI.SPI_module spiBus, Cpu.Pin latchPin)
